...
public final class beauty_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String name=session.getAttribute("username").toString(); 
      ...
      out.write("         <br>\n");
      out.write("         \n");
      out.write("         <center><h1 class=\"heading\">Beauty Care Products</h1></center>\n");
      out.write("         <br>\n");
      out.write("          <div class=\"item active\">\n");
      out.write("              <img src=\"images/wall/BEAUTY.jpg\" alt=\"Los Angeles\" style=\"width:100%; height: 400px;\">\n");
      ...
      out.write("            ");
            ...
            try
            {
                ...
                try
                {
                    String a="select * from addmedicinenonprecription where cat='Beauty'";
                    PreparedStatement mystatement=myconnection.prepareStatement(a);
                    ResultSet myres=mystatement.executeQuery();
                    if(myres.next())
                    {
