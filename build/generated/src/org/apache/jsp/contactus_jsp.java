...
public final class contactus_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 String name=session.getAttribute("username").toString(); 
      ...
      out.write("\t\t\t<div class=\"agileinfo_mail_grids\">\n");
      out.write("\t\t\t\t<div class=\"col-md-4 agileinfo_mail_grid_left\">\n");
      out.write("\t\t\t\t\t<ul>\n");
      out.write("                                            <li><i class=\"fa fa-home\" style=\"color: #19a9b4;\" aria-hidden=\"true\"></i></li>\n");
      out.write("\t\t\t\t\t\t<li>address<span>868 1st Avenue NYC.</span></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t<li><i class=\"fa fa-envelope\" style=\"color: #19a9b4;\" aria-hidden=\"true\"></i></li>\n");
      out.write("\t\t\t\t\t\t<li>email<span><a href=\"mailto:info@example.com\">info@example.com</a></span></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t<li><i class=\"fa fa-phone\" style=\"color: #19a9b4;\" aria-hidden=\"true\"></i></li>\n");
      out.write("\t\t\t\t\t\t<li>call to us<span>(+123) 233 2362 826</span></li>\n");
      out.write("\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"col-md-8 agileinfo_mail_grid_right\">\n");
      out.write("\t\t\t\t\t<form action=\"#\" method=\"post\">\n");
      out.write("\t\t\t\t\t\t<div class=\"col-md-6 wthree_contact_left_grid\">\n");
      ...
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"col-md-6 wthree_contact_left_grid\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"Telephone\" value=\"Telephone*\" onfocus=\"this.value = '';\" onblur=\"if (this.value == '') {this.value = 'Telephone*';}\" required=\"\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"Subject\" value=\"Subject*\" onfocus=\"this.value = '';\" onblur=\"if (this.value == '') {this.value = 'Subject*';}\" required=\"\">\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t<div class=\"clearfix\"> </div>\n");
      out.write("\t\t\t\t\t\t<textarea  name=\"Message\" onfocus=\"this.value = '';\" onblur=\"if (this.value == '') {this.value = 'Message...';}\" required=\"\">Message...</textarea>\n");
      out.write("\t\t\t\t\t\t<input type=\"submit\" style=\"background:  #19a9b4;\" value=\"Submit\">\n");
      out.write("\t\t\t\t\t\t<input type=\"reset\" value=\"Clear\" style=\"background:  #19a9b4;\">\n");
      out.write("\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"clearfix\"> </div>\n");
      out.write("\t\t\t</div>\n");
      ...
      out.write("\t\t<iframe src=\"https://www.google.com/maps?q=Jalandhar,+Punjab%output=embed\" style=\"border:0\"></iframe>\n");
      out.write("\t</div>\n");
      out.write("        \n");
      out.write("        ");
