...
<html>
    ...
    <body>
        <%
         ...
         <center><h1 class="heading">Baby And Mother Products</h1></center>
         <br>
         
          <div class="item active">
              <img src="images/wall/New folder/MOTHER AND BABY IMG.jpg" alt="Los Angeles" style="width:100%; height: 400px;">
        ...
        <div class="row">
            ...
            try
            {
                ...
                try
                {
                    String a="select * from addmedicinenonprecription where cat='Baby And Mother'";
