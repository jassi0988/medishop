<%-- 
    Document   : nonpremedilist
    Created on : 25 Mar, 2018, 1:04:26 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body>
        ...
        <h1 id="cen">Non Prescription Product List</h1><br><br>
        ...
        <%
                            try
                            {
                                ...
                                try
                                {
                                    String a="select * from addmedicinenonprecription";
                                    ...
                                    if(myres.next())
                                    {
                                        ...
                                        do
                                        {
                                            ...
                                            + "<td><a href='updateproduct.jsp?bno="+myres.getString("bno")+"'>Update</a></td>"   
