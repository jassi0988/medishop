...
<%
    Thread.sleep(500);
  {
        ...
        String bno=" ",name=" ",nptype=" ",com=" ",description=" ",price=" ",expdate=" ", imagename=" ",path=" ",mfddate=" ";
        ...
        if(isMultipart)
        {
            ...
            for(FileItem myitem:items)
            {
                if (myitem.isFormField())
                {
                    ...
                    else if(itemName1.equals("nptype"))
                    {
                         nptype=value;
                    }
                    ...
                    else if(itemName1.equals("descrption"))
                    {
                         description=value;
                    }
