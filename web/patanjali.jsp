...
<html>
    ...
    <body>
        <%
         ...
         <center><h1 class="heading">Patanjali Products</h1></center>
         <br>
         <div class="item active">
             <img src="images/wall/AYURVEDIC.jpg" alt="Los Angeles" style="width:100%; height: 400px;">
        ...
        <div class="row">
            ...
            try
            {
                ...
                try
                {
                    String a="select * from addmedicinenonprecription where cat='Patanjali'";
