...
<html>
    ...
    <body>
        <%
         ...
         <div class="h">
             <center><h1 class="heading">Personal Care</h1></center>
         </div>
         <br>
          <div class="item active">
              <img src="images/wall/New folder/PERSONAL CARE IMG.jpg" alt="Los Angeles" style="width:100%; height: 400px;">
        ...
        <div class="row">
            ...
            try
            {
                ...
                try
                {
                    String a="select * from addmedicinenonprecription where cat='Personal Care'";
